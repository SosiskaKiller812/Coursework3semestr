...
private:
    ...
    void processStopLine(const QString& line, int lineNumber, std::shared_ptr<Route>& currentRoute) const;
    void processTripLine(const QString& line, int lineNumber, std::shared_ptr<Route>& currentRoute) const;
